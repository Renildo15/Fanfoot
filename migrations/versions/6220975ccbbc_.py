...
Revision ID: 6220975ccbbc
Revises: 
Create Date: 2025-10-03 17:20:25.644689
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('type', sa.Enum('LEAGUE', 'CUP', 'LEAGUE_KNOCKOUT', name='competitiontype'), nullable=False),
    ...
    sa.Column('surname', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('age', sa.Integer(), nullable=False),
    sa.Column('position', sa.Enum('GK', 'RB', 'LB', 'CB', 'RWB', 'LWB', 'CDM', 'CM', 'CAM', 'RM', 'LM', 'RW', 'LW', 'CF', 'ST', name='position'), nullable=False),
    sa.Column('secondary_position', sa.Enum('GK', 'RB', 'LB', 'CB', 'RWB', 'LWB', 'CDM', 'CM', 'CAM', 'RM', 'LM', 'RW', 'LW', 'CF', 'ST', name='position'), nullable=True),
    sa.Column('preferred_foot', sa.Enum('R', 'L', 'B', name='playerpreferredfoot'), nullable=False),
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INJURED', 'SUSPENDED', 'ACADEMY', 'RETIRED', name='playerstatus'), nullable=False),
    ...
    sa.Column('country_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['country_id'], ['country.id'], ),
    sa.ForeignKeyConstraint(['current_club_id'], ['club.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    with op.batch_alter_table('player', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_player_full_name'), ['full_name'], unique=False)
    ...
    op.create_table('playerstatsseason',
    sa.Column('id', sa.Integer(), nullable=False),
