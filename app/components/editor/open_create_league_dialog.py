...
def open_create_league_dialog(page: ft.Page):
    ...
    search_field = ft.TextField(
        label="Buscar país",
        on_change=lambda e: filter_countries(e),
        width = 300
    )
    ...
    def filter_countries(e):
        ...
        if search_field:
            filtered_countries = [c for c in all_countries if search_text in c.name.lower()]
        else:
                ...
                [
                    ft.Column(
                        [
                            ...
                            ft.Row([level, max_teams, primary_color, secondary_color], spacing=10),
                        ],
                        spacing=10,
                    ),
